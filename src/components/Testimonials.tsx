  ...
  const testimonials = [
    {
      name: "רחל כהן",
      role: "מנהלת צוות",
      text: "הסדנה הייתה פשוט מושלמת! כל הצוות נהנה והתחבר, ויצאנו עם ספלים מקסימים שאנחנו משתמשים בהם כל יום.",
      rating: 5
    },
    {
      name: "דניאל לוי",
      role: "אבא לשלושה",
      text: "הילדים שלי (גילאי 8, 12, 15) נהנו מטורף! גם אני שחשבתי שאני לא יצירתי, יצאתי עם ספל שאני גאה בו.",
      rating: 5
    },
    {
      name: "מיכל אברהם",
      role: "מארגנת אירועים",
      text: "יערה הביאה אווירה כל כך חמה ונעימה. המשתתפות בסדנת בת המצווה עדיין מדברות על זה!"
    }
  ];
